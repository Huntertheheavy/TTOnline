...
app.get("/match/:MatchID",(req,res)=>{
    ...
    connection.execute('SELECT cards.CardsName,tileboard.CurrentHealth,cards.Health,tileboard.LocationID FROM tileboard INNER JOIN cards on tileboard.cardID = cards.cardID Where tileboard.MatchID = ? and tileboard.CurrentHealth > 0',
    [Match],
        function (err, results, fields) {
